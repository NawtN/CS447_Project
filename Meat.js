...
export default function Meat() {
  ...
  const fruits = [
    { id: '1', name: 'beaf', image: require('./assets/icon.png') },
    { id: '2', name: 'lamb', image: require('./assets/icon.png') },
    { id: '3', name: 'chieken', image: require('./assets/icon.png') },
    { id: '4', name: 'turkey', image: require('./assets/icon.png') },
  ];
